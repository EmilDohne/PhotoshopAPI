...
class TextLayer_32bit(Layer_32bit):
    ...
    def set_anti_alias(self: TextLayer_32bit, method: psapi.enum.AntiAliasMethod) -> None:
    ...
    def split_paragraph_run(self: TextLayer_32bit, run_index: int, char_offset: int) -> None:
