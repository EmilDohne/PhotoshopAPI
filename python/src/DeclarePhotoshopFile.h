...
{
	py::class_<PhotoshopFile> photoshopFile(m, "PhotoshopFile", R"pbdoc(
		...
		details are currently not meant to be modified
	)pbdoc");
	...
	photoshopFile.def_static("find_bitdepth", [](const std::string& filepath)
		{
