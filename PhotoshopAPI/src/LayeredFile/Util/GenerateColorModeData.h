...
template <typename T>
ColorModeData generateColorModeData(const LayeredFile<T>& layeredFile)
{
	// We dont actually do any generation of this data here as indexed colours are not currently supported
